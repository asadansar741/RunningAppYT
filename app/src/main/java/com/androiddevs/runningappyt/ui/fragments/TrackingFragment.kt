...
import com.androiddevs.runningappyt.other.Constants.POLLY_LINE_COLOR
import com.androiddevs.runningappyt.other.Constants.POLLY_LINE_WIDTH
...
val CANCEL_TRACKING_DIALOG_TAG="CANCEL_TRACKING_DIALOG_TAG"
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    private fun addLatestPolyLine (){
        if (pathPoints.isNotEmpty() && pathPoints.last().size>1){
            ...
            val polyLineOptions= PolylineOptions()
                .color(POLLY_LINE_COLOR)
                .width(POLLY_LINE_WIDTH)
                .add(preLastLatLng)
                .add(lastLatLng)
    ...
    private fun endRunAndSaveToDb(){
        map?.snapshot { bitmap->
            ...
            val run=Run(bitmap,dateTimeStamp,avgSpeed,distanceInMeter,currentTimeMillis,caloriesBurned)
